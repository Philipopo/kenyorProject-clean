...
class EOQReportV2(models.Model):
    ...
    eoq = models.PositiveIntegerField(blank=True, null=True, help_text="Calculated Economic Order Quantity")
    reorder_point = models.PositiveIntegerField(blank=True, null=True, help_text="Inventory level to trigger reorder")
    total_cost = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True, help_text="Total inventory cost at EOQ")
