...
class ItemAdmin(admin.ModelAdmin):
    list_display = ('name', 'part_number', 'serial_number', 'material_class', 'naira_cost', 'weight', 'dollar_cost', 'manufacturing_date', 'total_quantity', 'available_quantity', 'created_at')
