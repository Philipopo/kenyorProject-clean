...
class WarehouseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['user', 'created_at', 'updated_at', 'warehouse_uid']
...
class ItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'total_quantity', 'available_quantity', 'created_by', 'po_number', 'serial_number', 'naira_cost', 'weight', 'dollar_cost', 'manufacturing_date', 'initial_quantity'
        ]
